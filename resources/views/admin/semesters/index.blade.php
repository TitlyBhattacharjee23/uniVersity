                       ...
                       <div class="modal fade" id="addCourseModal{{ $semester->semester_id }}" tabindex="-1">
                           <div class="modal-dialog">
                               <div class="modal-content">
                                   ...
                                   <form
                                       action="{{ route('admin.semester.courses.store', ['admin_id' => $admin_id, 'semester_id' => $semester->semester_id]) }}"
                                       method="POST">
                                       @csrf
                                       <div class="modal-body">
                                           ...
                                           <div class="mb-3">
                                               ...
                                               <input type="number" name="credit" class="form-control"
                                                   value="{{ $course->credit ?? 3.0 }}" required min="1.0" max="3.0"
                                                   step="0.5" />
                                           </div>
                                           <div class="mb-3">
                           ...
                           <div class="modal fade" id="editCourseModal{{ $course->course_id }}" tabindex="-1">
                               <div class="modal-dialog">
                                   <div class="modal-content">
                                       ...
                                       <form
                                           action="{{ route('admin.semester.courses.update', ['admin_id' => $admin_id, 'semester_id' => $semester->semester_id, 'course_id' => $course->course_id]) }}"
                                           method="POST">
                                           @csrf
                                           @method('PUT')
                                           <div class="modal-body">
                                               ...
                                               <div class="mb-3">
                                                   <label for="credit">Credit Hours</label>
                                                   <input type="number" name="credit" class="form-control"
                                                       value="{{ $course->credit }}" required min="1.0" max="3.0"
                                                       step="0.5" />
                                               </div>
                                               <div class="mb-3">
                                                   <label for="teacher_id">Teacher</label>
